...
export default function Verification() {
  ...
  return <Layout area="internal"><section className="py-8"><div className="container-page"><Eyebrow>내부 운영 · 실제 정합성 API</Eyebrow><h1 className="mt-2">정합성 검증</h1><p className="mt-2 text-ops-muted">쿠폰 단위로 원장 정합성 검증을 즉시 실행합니다.</p></div></section>
