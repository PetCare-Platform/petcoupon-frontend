    ...
    <Layout area="internal" page="load-test-reset">
      <section className="py-10">
        <div className="container-page">
          ...
          <p className="mt-4 max-w-3xl text-[18px] text-ink-muted">개발 환경에서만 등록되는 재고 초기화 API를 호출합니다. 발급 이력과 관련 테스트 데이터를 삭제하므로 대상 쿠폰 ID를 확인하세요.</p>
        </div>
      </section>

      <section className="pb-20">
        <div className="container-page grid gap-6 lg:grid-cols-[5fr_7fr]">
          <form onSubmit={handleSubmit} className="rounded-[2rem] border border-hairline bg-white p-6 shadow-[0_22px_60px_-42px_rgba(23,36,58,0.4)] md:p-8">
          ...
          <div className="rounded-[2rem] bg-sky/45 p-6 md:p-8">
